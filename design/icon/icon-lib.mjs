...
//                                       and rumen-icon.html (Artifact fragment)
...
// rumen-icon.html (a fragment for the Artifact tool, theme-aware).
...
`;
  ...
  const artifactPage = `<title>Rumen Icon</title>
${fontLink}
<style>
  :root { --bg: #E9EAE6; --ink: #222A26; --muted: #5E6863; --dock: rgba(255,255,255,.55); --dock-line: rgba(0,0,0,.08); }
...
${content}`;
  ...
  await writeFile(join(previewDir, 'rumen-icon.html'), artifactPage);
}
